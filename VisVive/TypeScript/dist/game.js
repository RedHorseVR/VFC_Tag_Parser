...
class Ball {
    constructor(x, y, size) {
        this.speedX = 0; // Initialize with default value
        this.speedY = 0; // Initialize with default value
        this.x = x;
        this.y = y;
        this.width = size;
        this.height = size;
...
class Game {
    constructor() {
        ...
        // Create paddles
        this.player1 = new Paddle(50, HEIGHT / 2 - PADDLE_HEIGHT / 2, PADDLE_WIDTH, PADDLE_HEIGHT);
        this.player2 = new Paddle(WIDTH - 50 - PADDLE_WIDTH, HEIGHT / 2 - PADDLE_HEIGHT / 2, PADDLE_WIDTH, PADDLE_HEIGHT);
        // Create ball
        this.ball = new Ball(WIDTH / 2 - BALL_SIZE / 2, HEIGHT / 2 - BALL_SIZE / 2, BALL_SIZE);
